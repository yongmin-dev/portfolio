...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
					...
					<div class="row">
						...
						<div class="col-lg-6 col-sm-6">
							<div class="single_post post_1">
								...
								<div class="single_post_text text-center">
									<a href="category.html"><h5>Fashion / Life style</h5></a> <a
										href="single-blog.html"><h2>Your life is a product
											your right decisions</h2></a>
									<p>Posted on April 15, 2019</p>
								</div>
							</div>
						</div>
						...
						<div class="single_sidebar_wiget">
							...
							<div class="single_catagory_item category">
								<ul class="list-unstyled">
									<li><a href="category.html">Culture</a> <span>(15)</span>
									</li>
									<li><a href="category.html">Creative Design</a> <span>(15)</span>
									</li>
									<li><a href="category.html">Illustration</a> <span>(15)</span>
									</li>
									<li><a href="category.html">Production</a> <span>(15)</span>
									</li>
									<li><a href="category.html">Mangement</a> <span>(15)</span>
									</li>
									<li><a href="category.html">Branding</a> <span>(15)</span>
									</li>
								</ul>
							</div>
						</div>
	...
	<section class="social_connect_part margin-top">
